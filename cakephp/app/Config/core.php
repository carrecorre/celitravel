 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qyJfIxfs2guVoUubWwvniR2G0Fgaasde');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '7685930965745354249674968dfre');
...
Configure::write('MAPS_API_CSS', 'https://unpkg.com/leaflet@1.6.0/dist/leaflet.css');
Configure::write('MAPS_API_JS', 'https://unpkg.com/leaflet@1.6.0/dist/leaflet.js');
