<div class="reviews index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('general_rate'); ?></th>
			<th><?php echo $this->Paginator->sort('gluten_knowledge'); ?></th>
			<th><?php echo $this->Paginator->sort('gluten_adaptation'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($review['Review']['general_rate']); ?>&nbsp;</td>
		<td><?php echo h($review['Review']['gluten_knowledge']); ?>&nbsp;</td>
		<td><?php echo h($review['Review']['gluten_adaptation']); ?>&nbsp;</td>
		<td>
